...
public class ProfilAdmin extends AppCompatActivity {
    ...
    private ImageView btnNotes, btnMessages, btnProfil, btnNotifications;
    ...
    private void setupListeners() {
        ...
        btnNotifications.setOnClickListener(v -> navigateTo(NotificationsAdmin.class));
        btnMessages.setOnClickListener(v -> navigateTo(DashboardMessages.class));
        btnNotes.setOnClickListener(v -> navigateTo(DashboardInscriptions.class));
    }
